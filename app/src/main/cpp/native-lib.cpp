...
Java_com_example_zhoujianyu_objectrecognition_MainActivity_readDiffStart(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_zhoujianyu_objectrecognition_MainActivity_readDiffStop(JNIEnv *env, jobject instance) {
